...
all_blueprints = {
    ...
    "simulation-blueprint": "dimos.navigation.smart_nav.blueprints.simulation:simulation_blueprint",
    "simulation-pgo-blueprint": "dimos.navigation.smart_nav.blueprints.simulation_pgo:simulation_pgo_blueprint",
    "simulation-route-blueprint": "dimos.navigation.smart_nav.blueprints.simulation_route:simulation_route_blueprint",
    "simulation-slam-blueprint": "dimos.navigation.smart_nav.blueprints.simulation_slam:simulation_slam_blueprint",
    ...
    "unitree-g1-nav-arise-onboard": "dimos.robot.unitree.g1.blueprints.navigation.unitree_g1_nav_arise_onboard:unitree_g1_nav_arise_onboard",
...
all_modules = {
    ...
    "far-planner": "dimos.navigation.smart_nav.modules.far_planner.far_planner.FarPlanner",
    ...
    "global-map": "dimos.navigation.smart_nav.modules.global_map.global_map.GlobalMap",
    ...
    "local-planner": "dimos.navigation.smart_nav.modules.local_planner.local_planner.LocalPlanner",
    ...
    "pgo": "dimos.navigation.smart_nav.modules.pgo.pgo.PGO",
    ...
    "terrain-analysis": "dimos.navigation.smart_nav.modules.terrain_analysis.terrain_analysis.TerrainAnalysis",
    "terrain-map-ext": "dimos.navigation.smart_nav.modules.terrain_map_ext.terrain_map_ext.TerrainMapExt",
    "tui-control-module": "dimos.navigation.smart_nav.modules.tui_control.tui_control.TUIControlModule",
