...
class TestViewerProtocolE2E:
    ...
    def test_full_viewer_session_sequence(self) -> None:
        ...
        pt = received[0]
        assert pt.x == pytest.approx(3.14)
        assert pt.y == pytest.approx(2.71)
        assert pt.z == pytest.approx(1.41)
...
class TestViewerBinaryConnectMode:
    ...
    def test_viewer_ws_client_connects(self) -> None:
        ...
        stdout = proc.stdout.read().decode(errors="replace") if proc and proc.stdout else ""
